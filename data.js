const ABJAD_DATABASE = {
    ...
    verses_by_abjad: {
        "786": { verse: "Al-Fatiha 1:1", arabic: "بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ", translation: "Au nom d'Allah, le Tout Miséricordieux, le Très Miséricordieux", theme: "Basmala" },
        "2713": { verse: "Al-Baqarah 2:255", arabic: "اللَّهُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ", translation: "Allah ! Point de divinité à part Lui, le Vivant, Celui qui subsiste par Lui-même", theme: "Ayat al-Kursi" },
        "111": { verse: "Al-Ikhlas 112:1", arabic: "قُلْ هُوَ اللَّهُ أَحَدٌ", translation: "Dis: Il est Allah, Unique", theme: "Unicité divine" },
        "181": { verse: "Al-Ikhlas 112:1-4", arabic: "سورة الإخلاص كاملة", translation: "Sourate Al-Ikhlas (Le Monothéisme pur)", theme: "Monothéisme" },
        "129": { verse: "Al-Anbiya 21:87", arabic: "لَّا إِلَٰهَ إِلَّا أَنتَ سُبْحَانَكَ إِنِّي كُنتُ مِنَ الظَّالِمِينَ", translation: "Pas de divinité à part Toi ! Pureté à Toi ! J'ai été vraiment du nombre des injustes", theme: "Invocation de Jonas" },
        "113": { verse: "Al-Mulk 67:1", arabic: "تَبَارَكَ الَّذِي بِيَدِهِ الْمُلْكُ وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ", translation: "Béni soit Celui dans la main de qui est la royauté, et Il est Omnipotent", theme: "La Royauté" },
        "114": { verse: "An-Nas 114:1", arabic: "قُلْ أَعُوذُ بِرَبِّ النَّاسِ", translation: "Dis: Je cherche protection auprès du Seigneur des hommes", theme: "La protection divine" }
    },
    ...
    names_of_allah: [
        ...
        { name: "الْبَرُّ", transliteration: "Al-Barr", translation: "La Source de la Piété", abjad: 202 },
    ...
    famous_words: { 
        "محمد": { meaning: "Muhammad (Le Prophète)", abjad: 92 }, 
        ...
        "بسم الله": { meaning: "Au nom d'Allah", abjad: 102 }
    },

    surahs: { 
        "1": { name: "Al-Fatiha", arabic: "الفاتحة", verses: 7, theme: "L'Ouverture" },
        "2": { name: "Al-Baqarah", arabic: "البقرة", verses: 286, theme: "La Vache" },
        "36": { name: "Ya-Sin", arabic: "يس", verses: 83, theme: "Le Cœur du Coran" },
        "55": { name: "Ar-Rahman", arabic: "الرحمن", verses: 78, theme: "Le Tout Miséricordieux" },
        "67": { name: "Al-Mulk", arabic: "الملك", verses: 30, theme: "La Royauté" },
        "112": { name: "Al-Ikhlas", arabic: "الإخلاص", verses: 4, theme: "Le Monothéisme Pur" },
        "113": { name: "Al-Falaq", arabic: "الفلق", verses: 5, theme: "L'Aube Naissante" },
        "114": { name: "An-Nas", arabic: "الناس", verses: 6, theme: "Les Hommes" }
    }
};
...
// Fonction de recherche par valeur
